        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 animate-fade-up">
            <div className="inline-flex items-center space-x-2 bg-insurance-50 rounded-full py-1 px-3 border border-insurance-100">
              <span className="text-insurance-700 text-sm font-medium">Protecting What Matters Most</span>
            </div>
            
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
              Ensuring Your Loved Ones <span className="text-insurance-600">Are Protected</span>
            </h1>
            
            <p className="text-lg text-gray-600 max-w-xl">
              Our platform ensures nominees are notified of policies when policyholders pass away, providing financial security when it matters most.
            </p>
            ...
            <div className="relative glass-card rounded-3xl p-8 shadow-xl animate-fade-in">
              <div className="grid grid-cols-1 gap-6">
                <div className="flex items-start space-x-4 rounded-xl bg-white p-4 shadow-sm">
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900">Policy Protection</h3>
                    <p className="text-sm text-gray-500">Securely store and manage all your insurance policies in one place.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4 rounded-xl bg-white p-4 shadow-sm">
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900">Nominee Notification</h3>
                    <p className="text-sm text-gray-500">Ensure your nominees are automatically notified when needed.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4 rounded-xl bg-white p-4 shadow-sm">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Rest easy knowing your family's financial future is secure.</p>
                  </div>
                </div>
              </div>
            </div>
